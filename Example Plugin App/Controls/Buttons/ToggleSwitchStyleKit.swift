...
//  AKSynthOne
//
//  Created by Matthew Fecher on 7/10/20.
...
public class ToggleSwitchStyleKit : NSObject {
    ...
    @objc dynamic public class func drawToggleSwitch(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 60, height: 31), resizing: ResizingBehavior = .aspectFit, isToggled: Bool = false) {
        ...
        //// Color Declarations
        let gray = UIColor(red: 0.416, green: 0.416, blue: 0.424, alpha: 1.000)
        let _222 = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let _111 = UIColor(red: 0.067, green: 0.067, blue: 0.067, alpha: 1.000)
        let _333 = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)

        //// Shadow Declarations
        let shadow = NSShadow()
        shadow.shadowColor = _111
        ...
        //// track Drawing
        let trackPath = UIBezierPath(roundedRect: CGRect(x: 7.75, y: 6.25, width: 36, height: 17), cornerRadius: 6)
        _222.setFill()
        trackPath.fill()
        _333.setStroke()
