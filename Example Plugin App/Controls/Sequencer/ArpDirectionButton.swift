...
//        let swipeRecognizer = UISwipeGestureRecognizer(target: self, action: #selector(random(_:)))
//        addGestureRecognizer(swipeRecognizer)
//    }
//
//    @objc func random(_ sender:UIPanGestureRecognizer) {
//        AKLog("randomizing?")
//        conductor.sequencer.isRandomized.toggle()
//        conductor.updateSequences()
//    }
